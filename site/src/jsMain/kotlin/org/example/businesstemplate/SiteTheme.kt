package org.example.businesstemplate
...
val BlueColor = Color.rgb(39,116,164)
val WhiteColor = Color.rgb(235,235,235)
...
fun initTheme(ctx: InitSilkContext) {
    ...
    ctx.theme.palettes.dark.background = Color.rgb(0xFAFAFA)
    ctx.theme.palettes.dark.color = Colors.Black
}
